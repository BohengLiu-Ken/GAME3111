...
public:
	...
	///<summary>
	/// Creates a Cone, and centered about the origin.  
	/// The bottom radius can vary to form various cone shapes rather than true
	// cylinders.  The slices and stacks parameters control the degree of tessellation.
	///</summary>
	...
	///<summary>
	/// Creates a Torus, and centered about the origin.
	///</summary>
